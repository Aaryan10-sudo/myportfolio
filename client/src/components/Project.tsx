      ...
      <div className="px-5 sm:px-12 md:mx-auto max-w-7xl">
        <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
          <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-normal  md:text-6xl md:tracking-tight font-sora">
            ...
            <span className="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-white to-primary lg:inline">
              My Works
            </span>{" "}
              ...
              {projects.map((project, index) => (
                <SwiperSlide key={index}>
                  <div className="relative overflow-hidden ">
                    <div className="relative overflow-hidden">
                      <div className="flex items-center flex-none px-4 bg-[url('/spidermanbg.webp')] bg-cover bg-blend-screen rounded-b-none h-11 rounded-xl">
                    ...
                    <div className="p-4 bg-[url('/spidermanbg.webp')] bg-cover bg-center rounded-b-xl text-white">
                      <Link
                        href={project.url}
